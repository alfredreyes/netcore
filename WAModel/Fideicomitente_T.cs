//Fecha Creación:5/24/2019 6:13:18 PM Template ModelClass, Author: Alfredo Reyes C., V1
using System;

namespace WAModel
{
    public class Fideicomitente_T
    {
      
            public string ID  { get; set; }      
      
            public string NumeroFideicomitente  { get; set; }      
